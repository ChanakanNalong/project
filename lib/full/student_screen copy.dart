...
Future<List<Student>> fetchStudents() async {
  final response =
      await http.get(Uri.parse('http://10.5.50.97/api/student.php'));
...
Future<int> deleteStudent(Student student) async {
  final response = await http.delete(
    Uri.parse(
        'http://10.5.50.97/api/student.php?student_code=${student.studentCode}'),
...
Future<int> insertStudent(Student student) async {
  final response = await http.post(
    Uri.parse('http://10.5.50.97/api/student.php'),
    headers: <String, String>{
      'Content-Type': 'application/json; charset=UTF-8',
    },
